...
def train_ars_script():
    ...
    # Nota: Poti adauga num_deltas in Config daca vrei, sau lasi default in Agent
    print(f"Initializare ARS (StepSize={Config.LR_ARS})...")
    agent = ARSAgent(state_dim=Config.STATE_DIM, action_dim=Config.ACTION_DIM, learning_rate=Config.LR_ARS)
    
    # Numarul de iteratii din Config
    num_iterations = Config.ARS_ITERATIONS
